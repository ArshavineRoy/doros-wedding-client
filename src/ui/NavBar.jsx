...
//       <nav className="flex items-center justify-between p-8 lg:px-8 bg-black h-8" aria-label="Global">
...
//           <a href="/" className="text-base font leading-6 text-white hover:text-[#73332D]">Planning Tools</a>
...
//           <button className="bg-white text-black text-base font-semibold leading-6 p-0.5 w-20  rounded hover:bg-[#73332D]">
...
//                 <button className="bg-white text-black text-base font-semibold leading-6 p-2 rounded hover:bg-blue-600">
//                   <a href="/login" className="text-w">Login</a>
//                 </button>
//               </div>
//             </div>
//           </div>
