...
const NavBar = () => {
  ...
  <nav className="flex items-center justify-between p-6 lg:px-8 bg-black h-20" aria-label="Global">
    ...
    <div className="lg:flex lg:gap-x-8 mt-2 hidden lg:block">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <a href="/planning-tools" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-[#73332D]">Planning Tools</a>
