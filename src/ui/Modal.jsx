...
function Modal({ children, close }) {
  return createPortal(
    <div className="fixed top-0 left-0 w-full h-full bg-gray-300 bg-opacity-50 backdrop-filter backdrop-blur-md z-50 flex items-center justify-center">
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg p-8 transition duration-500 overflow-scroll max-h-[700px]">
        <button
          onClick={close}
